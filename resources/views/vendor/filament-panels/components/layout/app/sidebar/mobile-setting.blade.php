<div x-cloak x-show="sidebarOpen" class="md:hidden">
    <div x-cloak x-show="sidebarOpen" @click="sidebarOpen = false" x-transition:enter-start="opacity-0"
    ...
    <div class="fixed inset-0 flex z-40">
        <div x-cloak x-show="sidebarOpen" x-transition:enter-start="-translate-x-full"
            ...
            <div class="absolute top-0 right-0 -mr-14 p-1">
                <button x-show="sidebarOpen" @click="sidebarOpen = false"
                    class="flex items-center justify-center h-12 w-12 rounded-full focus:outline-none focus:bg-secondary-600">
            ...
            <x-filament-panels::layout.app.sidebar.navigation-setting />
        </div>
