<div class="flex flex-col justify-between bg-primary-800 text-center w-16">
    <div>
        <div class="px-2 bg-white">
            <a class="shrink-0 flex items-center justify-center p-2" href="">
    ...
    <div class="shrink-0 flex flex-col items-center space-y-3 pb-4">
        <button type="button" aria-pressed="false"
            ...
            <span
                class="translate-x-0 dark:translate-x-5 relative inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200">
                <span
                    class="dark:hidden opacity-100 ease-in duration-200 dark:opacity-0 dark:ease-out dark:duration-100 absolute inset-0 h-full w-full flex items-center justify-center transition-opacity"
                    aria-hidden="true">
                    <svg class="h-3 w-3 text-secondary-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        fill="currentColor">
                        <path
                ...
                <span
                    class="hidden dark:flex dark:opacity-0 dark:ease-out dark:duration-100 absolute inset-0 h-full w-full items-center justify-center transition-opacity opacity-10 ease-in duration-200"
                    aria-hidden="true">
                    <svg class="h-3 w-3 text-secondary-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        fill="currentColor">
        ...
        @can('access_setting')
            <a href="{{ route('shopper.settings.index') }}"
        ...
        <a href="https://laravelshopper.dev" target="_blank"
